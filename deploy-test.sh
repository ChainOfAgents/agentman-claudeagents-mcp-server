...
# MCP Server - Test Environment Deployment Script
...
# Service naming
SERVICE_NAME="test-claudeagents-server"
MCP_SERVER_NAME="claudeagents_mcp"
PATH_PREFIX="claudeagents"               # URL: mcp.agentman.ai/claudeagents/mcp (same path for test, different Cloud Run service)

# OAuth configuration — not used for claudeagents
OAUTH_ISSUER=""
...
echo "🧪 Deploying TEST ${MCP_SERVER_NAME} MCP Server to Google Cloud"
echo "================================================================"
...
echo "🧪 Test Commands:"
echo "================"
echo "# Test direct Cloud Run endpoint"
...
echo "🧪 TEST ${MCP_SERVER_NAME} MCP Server is now live!"
